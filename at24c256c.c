...
/* The following files provide basic functionality for stm32 boards,
 * like a memory map of peripherals, register functions and basic IO.
 * I haven't published these (yet). In case interested, please leave 
 * a message. You should be able to integrate this driver using HAL or
 * your own OS without too  much effort  */
#include <sys/mmap.h>
